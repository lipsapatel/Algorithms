 ...
 * 2) Bubble sort compares each pair of adjacent items and swaps them if they are in the wrong order.
 * 3) The pass through the list is repeated until no swaps are needed, that means array is sorted.
 ...
 *
 * 1) As seen in the program above, bubble sort compares all the pairs in the array, even when original array is sorted
