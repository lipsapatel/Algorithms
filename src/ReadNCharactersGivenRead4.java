 ...
 * implement a method to read n characters.
 ...
 so return 3. Note that "abc" is the file's content, not buf. buf is the destination buffer that you will have to write the
 results to.
...
public class ReadNCharactersGivenRead4 {
    ...
    public int read(char[] buf, int n) {
        ...
        while (!eof && total < n) {
            ...
            //The actual characters that need to be copied
