 ...
 * then place nuts at its right place.
 *
 * Time Complexity: O(n)
 * Space Complexity: O(n)
 *
 * Using IK.Sorting.Sorting1.Class.PreClass.QuickSort:
 *
...
public class NutsAndBoltsProblem {
    ...
    private static int partition(int[] array, int low, int high, int pivot) {
        ...
        int i = low - 1;
        boolean placePivotOnce = false; //If there are duplicate pivot place only one pivot to position high
