...
public class TowerOfHanoi {
    ...
    private static void towerOfHanoiHelper(int n, List<List<Integer>> steps, int peg1, int peg2, int peg3) {
        ...
        if (n == 1) {
            ...
            towerOfHanoiHelper(n - 1, steps, peg1, peg3, peg2);
            ...
            towerOfHanoiHelper(n - 1, steps, peg2, peg1, peg3);
        }
    }
